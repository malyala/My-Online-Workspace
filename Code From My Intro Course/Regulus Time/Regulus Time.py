...
#part 1: convert the secs to years, months, days, hours, minutes, seconds

#we do this with copied code================================================
        DST = False
...
#part 2: store the stuff in one list

    #postcondition is that we store the correct time as seperate fields
    #with the basic components used to print
        self.data = [months, days, years, hours, minutes, seconds, is_daylight_savings]
    ...
    def add_minutes(self, minutes):
        ...
        secs_yet_to_be_organized = self.to_seconds() + (minutes*60)
        
#==============Copied code from first Class========================================        
        DST = False
        years = (secs_yet_to_be_organized / 31104000) + 1 #number of seconds in a year, we add one b/c we start with year 1
        secs_yet_to_be_organized %= 31104000 #now we have time less than a year 
        if  7783200 <secs_yet_to_be_organized < 23335200: #if we are in the daylight saving time period
...
#==============End of copied part==========================================================
        ...
        #postcond: our new stored time is 'minutes' ahead of the first time
        self.data = [months, days, years, hours, minutes, seconds, is_daylight_savings]
